...
function generateHealthProblem(patientBirthDate,patientHealthCardNumber,familyDoctorMINC) {
...
console.log(generateHealthProblem(new Date(2002, 3, 3), "233422332as", "CAMD-8932-345"));
